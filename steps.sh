...
master_var_init () {
	...
	REF_ISO_PROFILE_REPO_GIT_URL="https://github.com/CachyOS/CachyOS-Live-ISO.git"
...
cachyos_target_os_mount_for_chroot () {
...
cachyos_target_os_unmount_for_chroot () {
...
##
## ## Cachyos / Build ISO / Package Required For Build
##

cachyos_build_iso_package_required () {
	...
	util_error_echo
	util_error_echo pacman -S --needed --noconfirm archiso mkinitcpio-archiso git squashfs-tools grub
	util_error_echo
	pacman -S --needed --noconfirm archiso mkinitcpio-archiso git squashfs-tools grub
...
##
## ## Cachyos / Build ISO / Steps
##

cachyos_build_iso_develop_test () {


	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Run / cachyos_build_iso_develop_test"
	util_error_echo "##"
	util_error_echo

	msg_master_args

	cachyos_build_iso_develop_test_prototype
...
cachyos_build_iso_develop_test_prototype () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Run / cachyos_build_iso_develop_test_prototype"
	util_error_echo "##"
	util_error_echo
	...
	#cachyos_build_iso_create

	#cachyos_build_iso_overlay
...
cachyos_build_iso_steps () {


	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Run / cachyos_build_iso_steps"
	util_error_echo "##"
	util_error_echo
...
##
## ## Cachyos / Build ISO / Prepare
##

cachyos_build_iso_prepare () {


	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Build ISO / Prepare"
	util_error_echo "##"
	util_error_echo


	cachyos_build_iso_prepare_work_dir
	cachyos_build_iso_prepare_iso_profile
...
##
## ## Cachyos / Build ISO / Prepare / Work Dir
##
...
##
## ## Cachyos / Build ISO / Prepare / ISO Profile
##
...
cachyos_build_iso_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Build ISO / Overlay"
	util_error_echo "##"
	util_error_echo

	cachyos_factory_master_os_file_overlay

	cachyos_master_os_file_overlay

	cachyos_master_os_package_overlay

	cachyos_master_os_installer_overlay

	cachyos_live_build_config_hook_overlay
...
##
## ## Cachyos / Master OS / Factory Overlay
##
...
cachyos_factory_master_os_file_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Master OS / Factory Overlay"
	util_error_echo "##"
	util_error_echo
...
cachyos_master_os_file_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Master OS / Overlay"
	util_error_echo "##"
	util_error_echo
...
cachyos_master_os_package_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Master OS / Package"
	util_error_echo "##"
	util_error_echo
...
cachyos_master_os_installer_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Master OS / Installer"
	util_error_echo "##"
	util_error_echo
...
##
## ## Cachyos / Live Build Config / Hook
##
...
cachyos_live_build_config_hook_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Master OS / Hook"
	util_error_echo "##"
	util_error_echo
...
##
## ## Cachyos / Build ISO / Archive
##

cachyos_build_iso_archive () {


	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Build ISO / Archive / Start"
	util_error_echo "##"
	util_error_echo
	...
	local build_agent_args="-p desktop -v"
	local build_agent_file_name="buildiso.sh"
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Build ISO / Archive / Done"
	util_error_echo "##"
	util_error_echo
...
cachyos_build_iso_create () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Cachyos / Build ISO / Create"
	util_error_echo "##"
	util_error_echo
...
##
## ## Cachyos / Build ISO / Start
##

cachyos_build_iso_start () {
